...
package aws // import "gopkg.in/DataDog/dd-trace-go.v0/contrib/aws/aws-sdk-go/aws"
...
func WrapSession(s *session.Session, opts ...Option) *session.Session {
	...
	s.Handlers.Send.PushFrontNamed(request.NamedHandler{
		Name: "gopkg.in/DataDog/dd-trace-go.v0/contrib/aws/aws-sdk-go/aws/handlers.Send",
		Fn:   h.Send,
	})
	s.Handlers.Complete.PushBackNamed(request.NamedHandler{
		Name: "gopkg.in/DataDog/dd-trace-go.v0/contrib/aws/aws-sdk-go/aws/handlers.Complete",
		Fn:   h.Complete,
	})
	return s
}
